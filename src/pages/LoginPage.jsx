...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <Helmet>
        <title>Sign In - SocialChat</title>
        <meta name="description" content="Sign in to your SocialChat account and start connecting with people worldwide through real-time chat and video calls." />
      </Helmet>
